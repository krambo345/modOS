...
import * as firestore from "@kernel/firebase/firestore";
...
export const kernel = {
  ...
  account: {
    ...
    async ensureUserData() {
      return await firestore.firestoreUserData();
    },

    async getSettings() {
      const data = await firestore.firestoreUserData();
    ...
    async updateSettings() {
      return await firestore.firestoreSettingsUpdate();
    },

    async updatePackages(packages: string[]) {
      return await firestore.firestorePackagesUpdate(
        packages
      );
    },

    async update() {
      return await firestore.firestoreUserUpdate();
    }
  },
